...
testedge[temp] = true
chasingbullet1 = CreateProjectile('shuriken', xtemp, ytemp)
...
testedge[temp] = true
chasingbullet2 = CreateProjectile('shuriken', xtemp, ytemp)
...
testedge[temp] = true
chasingbullet3 = CreateProjectile('shuriken', xtemp, ytemp)
